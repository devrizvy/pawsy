...
const postAdoptionRequest = catchAsync(async (req, res) => {
  ...
  const result = await AdoptionServices.postAdoptionRequest(
    req.body,
    token as string,
  );
  sendResponse(res, {
...
const getAdoptionRequests = catchAsync(async (req, res) => {
  ...
  sendResponse(res, {
    statusCode: status.OK,
    success: true,
    message: "Adoption requests retrived successfully",
    data: result,
  });
});
...
const updateAdoptionRequestStatus = catchAsync(async (req, res) => {
  ...
  const result = await AdoptionServices.updateAdoptionRequestStatus(requestedId as string, req.body);
  sendResponse(res, {
    statusCode: status.OK,
    success: true,
